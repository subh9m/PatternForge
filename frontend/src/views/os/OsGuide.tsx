...
import OsMainContent from './OsMainContent';
...
const OsGuide: React.FC<OsGuideProps> = ({ onBackToPortal }) => {
  const [isSidebarOpen, setIsSidebarOpen] = useState(true);
  const [activeTab, setActiveTab] = useState<string>('os_basics_arch');
