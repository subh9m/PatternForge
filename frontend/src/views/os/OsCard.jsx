...
export default function OsCard({ data }) {
  ...
  return (
    ...
    >
      ...
      <div className="border-b border-neutral-200 dark:border-neutral-800 dark:border-neutral-800">
        <button
        ...
        {showDeclaration && (
          <div className="p-6 bg-gray-100/30 dark:bg-[#070707]/30 border-t border-neutral-200 dark:border-neutral-800 dark:border-neutral-800">
      ...
      {(data.diagramUrl || data.internalImplementation) && (
        <div className="border-b border-neutral-200 dark:border-neutral-800 dark:border-neutral-800">
          ...
          {showInternal && (
            <div className="border-t border-neutral-200 dark:border-neutral-800 dark:border-neutral-800 bg-black/90 dark:bg-black/90 p-6 flex flex-col items-center space-y-6 overflow-x-auto">
              {data.diagramUrl && (
        ...
        <div className="space-y-3">
          {data.methods.map((row, idx) => {
            ...
            return (
              <div 
                key={idx}
                className={`border border-neutral-200 dark:border-neutral-800 dark:border-neutral-800 rounded-xl overflow-hidden transition-all duration-300
                  ${isExpanded 
              ...
              >
                ...
                {/* Accordion Content */}
                {isExpanded && (
                  <div className="px-5 pb-5 pt-1 space-y-4 border-t border-dashed border-neutral-200 dark:border-neutral-800 dark:border-neutral-800 animate-fadeIn">
                    ...
                    <div className="p-5 bg-amber-500/[0.05] dark:bg-amber-500/[0.03] border-l-2 border-amber-500/70 rounded-r-lg">
                      ...
                      <p className="text-[14px] md:text-[15px] italic text-gray-700 dark:text-neutral-300 font-sans leading-relaxed">
                    ...
                    <div className="space-y-2">
                      ...
                      <div 
                        className="os-rich-content text-[14px] md:text-[15px] text-gray-700 dark:text-neutral-300 font-sans font-normal leading-relaxed space-y-3"
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-3">
                      <div className="p-3.5 bg-white/80 dark:bg-neutral-900/30 border border-neutral-200 dark:border-neutral-800 dark:border-neutral-800 rounded-lg">
                        <span className="block text-[9.5px] font-black text-gray-400 uppercase tracking-wider font-mono">Mechanic / Key term</span>
