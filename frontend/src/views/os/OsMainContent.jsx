...
import { osConcepts } from './osRegistry';
...
export default function OsMainContent({ isOpen, toggleSidebar, activeTab }) {
  const ds = osConcepts.find(item => item.id === activeTab) || osConcepts[0];
