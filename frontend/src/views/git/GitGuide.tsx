...
import GitMainContent from './GitMainContent';
import { GitBranch, Sun, Moon } from 'lucide-react';

interface GitGuideProps {
  onBackToPortal: () => void;
}

const GitGuide: React.FC<GitGuideProps> = ({ onBackToPortal }) => {
  const [isSidebarOpen, setIsSidebarOpen] = useState(true);
  const [activeTab, setActiveTab] = useState<string>('git_basics_vcs');
