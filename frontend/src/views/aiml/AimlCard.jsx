    ...
    case 'aiml_fundamentals':
      return (
        <div className="space-y-3">
          ...
          <div className="p-5 bg-gray-50/50 dark:bg-black/40 border border-gray-200 dark:border-neutral-900 rounded-xl">
            <div className="border border-neutral-300 dark:border-neutral-800 p-4 rounded-xl bg-white dark:bg-neutral-950">
              ...
              <p className="text-[11.5px] font-bold text-gray-700 dark:text-gray-300 mb-3">Artificial Intelligence: Heuristic and algorithmic cognitive simulation.</p>
              ...
              <div className="border border-blue-200 dark:border-blue-900 p-4 rounded-xl bg-blue-500/[0.01]">
                ...
                <p className="text-[11.5px] font-bold text-gray-700 dark:text-gray-300 mb-3">Machine Learning: Models learning representations from mathematical dataset patterns.</p>
      ...
      return (
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-5 bg-gray-50/50 dark:bg-black/40 border border-gray-200 dark:border-neutral-900 rounded-xl">
            {/* Column 1: Input Data */}
            <div className="p-4 border border-gray-200 dark:border-neutral-800 rounded-xl bg-white dark:bg-neutral-950 space-y-3">
              ...
              <div className="space-y-2 text-xs">
                <div className="p-2 border border-dashed border-gray-250 dark:border-neutral-900 rounded">
    ...
    case 'ml_basics':
      return (
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-5 bg-gray-50/50 dark:bg-black/40 border border-gray-200 dark:border-neutral-900 rounded-xl">
            {/* Linear Regression */}
            <div className="p-4 border border-gray-200 dark:border-neutral-800 rounded-xl bg-white dark:bg-neutral-950 space-y-2">
              ...
              <h4 className="text-xs font-bold text-gray-800 dark:text-gray-250">Continuous Numeric Predictions</h4>
              ...
              <div className="h-10 w-full flex items-center justify-center bg-gray-50 dark:bg-black/20 border border-dashed border-gray-200 dark:border-neutral-900 rounded font-mono text-[9px] text-gray-400">
            ...
            <div className="p-4 border border-gray-200 dark:border-neutral-800 rounded-xl bg-white dark:bg-neutral-950 space-y-2">
              ...
              <h4 className="text-xs font-bold text-gray-800 dark:text-gray-250">Discrete Binary Outputs</h4>
        ...
        <div className="space-y-3">
          ...
          <div className="p-5 bg-gray-50/50 dark:bg-black/40 border border-gray-200 dark:border-neutral-900 rounded-xl overflow-x-auto">
            <div className="flex items-center space-x-3 text-xs font-mono min-w-[600px] py-2">
              <div className="p-3 bg-white dark:bg-neutral-950 border border-gray-200 dark:border-neutral-800 rounded-lg text-center shadow-sm">
      ...
      return (
        <div className="space-y-3">
          ...
          <div className="p-5 bg-gray-50/50 dark:bg-black/40 border border-gray-200 dark:border-neutral-900 rounded-xl space-y-4">
            {/* Step 1 */}
            <div className="p-4 border border-gray-250 dark:border-neutral-800 bg-white dark:bg-neutral-950 rounded-xl relative flex items-start space-x-4">
        ...
        <div className="space-y-3">
          ...
          <div className="p-5 bg-gray-50/50 dark:bg-black/40 border border-gray-200 dark:border-neutral-900 rounded-xl overflow-x-auto">
            <div className="flex items-center space-x-4 text-xs font-mono min-w-[550px] py-1">
              <div className="p-3 bg-white dark:bg-neutral-950 border border-gray-200 dark:border-neutral-800 rounded-lg shadow-sm text-center">
      ...
      return (
        <div className="space-y-3">
          ...
          <div className="p-5 bg-gray-50/50 dark:bg-black/40 border border-gray-200 dark:border-neutral-900 rounded-xl space-y-4">
            ...
            <div className="text-center text-[10px] text-gray-400 font-mono italic">
    ...
    case 'system_deployment':
      return (
        <div className="space-y-3">
          ...
          <div className="p-5 bg-gray-50/50 dark:bg-black/40 border border-gray-200 dark:border-neutral-900 rounded-xl space-y-4">
            <div className="p-3 bg-white dark:bg-neutral-950 border border-gray-200 dark:border-neutral-800 rounded-lg text-center font-mono text-xs">
