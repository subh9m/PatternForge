            ...
            >
              ...
              {isExpanded && (
                <div className="p-5 border-t border-neutral-200 dark:border-neutral-800 dark:border-neutral-900 space-y-6 animate-fadeIn">
                  ...
                  <div className="p-3.5 bg-indigo-500/[0.03] border-l-3 border-indigo-500 text-neutral-700 dark:text-neutral-300 rounded-r-lg font-sans text-xs flex items-center space-x-3 leading-relaxed">
