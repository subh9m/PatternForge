      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto flex flex-col justify-between">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 border-b border-gray-200 dark:border-neutral-800/80 mb-2">
              ...
              <select
                ...
                className="w-full bg-gray-50 dark:bg-neutral-950 border border-gray-200 dark:border-neutral-900 rounded-lg p-2 text-xs font-mono font-bold text-gray-800 dark:text-gray-200 focus:outline-none focus:border-fuchsia-500"
              >
                {projects.map(p => (
          ...
          <div className="p-4 border-t border-gray-200 dark:border-neutral-900 text-center font-mono text-[9px] text-gray-400">
