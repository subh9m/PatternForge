...
import ProjectsMainContent from './ProjectsMainContent';
import { projectsList } from './projectsRegistry';
...
const ProjectsGuide: React.FC<ProjectsGuideProps> = ({ onBackToPortal }) => {
