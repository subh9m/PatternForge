...
import CnMainContent from './CnMainContent';
import { Terminal, Sun, Moon } from 'lucide-react';

interface CnGuideProps {
  onBackToPortal: () => void;
}

const CnGuide: React.FC<CnGuideProps> = ({ onBackToPortal }) => {
  const [isSidebarOpen, setIsSidebarOpen] = useState(true);
  const [activeTab, setActiveTab] = useState<string>('cn_fundamentals');
