    ...
    <div className="bg-white/60 dark:bg-black/60 backdrop-blur-md border border-gray-255 dark:border-[#333] rounded-2xl p-6 md:p-8 shadow-lg space-y-6">
      ...
      {viewMode === 'glossary' ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 font-mono text-xs">
              ...
              <button
                ...
                className={`w-full p-4 border rounded-xl text-left transition-all cursor-pointer flex flex-col justify-between space-y-1
                  ${activeSnippetIdx === idx 
                    ...
                    : 'border-gray-200 dark:border-neutral-900 hover:border-green-500/10 text-gray-700 dark:text-gray-300'}`}
              >
          ...
          {/* Code Viewer Panel */}
          <div className="lg:col-span-2 border border-gray-255 dark:border-neutral-900 bg-neutral-950/70 rounded-xl p-5 flex flex-col justify-between min-h-[300px] relative">
