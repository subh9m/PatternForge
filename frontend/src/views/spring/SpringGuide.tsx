...
import SpringMainContent from './SpringMainContent';
import { Terminal, Sun, Moon } from 'lucide-react';

interface SpringGuideProps {
  onBackToPortal: () => void;
}

const SpringGuide: React.FC<SpringGuideProps> = ({ onBackToPortal }) => {
  const [isSidebarOpen, setIsSidebarOpen] = useState(true);
  const [activeTab, setActiveTab] = useState<string>('spring_core');
